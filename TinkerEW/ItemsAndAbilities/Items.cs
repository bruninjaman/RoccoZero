...
internal partial class Items
{
    ...
    public void Update()
    {
        if (!UpdateSleeper.Sleeping)
        {
            ...
            //Update items here
            soulRing.Update(localHero.Inventory.MainItems.Find(x => x.Id == AbilityId.item_soul_ring));
            ghostScepter.Update(localHero.Inventory.MainItems.Find(x => x.Id == AbilityId.item_ghost));
            eternalShroud.Update(localHero.Inventory.MainItems.Find(x => x.Id == AbilityId.item_eternal_shroud));
            veilOfDiscord.Update(localHero.Inventory.MainItems.Find(x => x.Id == AbilityId.item_veil_of_discord));
            ...
            etherealBlade.Update(localHero.Inventory.MainItems.Find(x => x.Id == AbilityId.item_ethereal_blade));
            scytheOfVyse.Update(localHero.Inventory.MainItems.Find(x => x.Id == AbilityId.item_sheepstick));
            shivasGuard.Update(localHero.Inventory.MainItems.Find(x => x.Id == AbilityId.item_shivas_guard));
            orchid.Update(localHero.Inventory.MainItems.Find(x => x.Id == AbilityId.item_orchid));
            bloodthorn.Update(localHero.Inventory.MainItems.Find(x => x.Id == AbilityId.item_bloodthorn));
            rodOfAtos.Update(localHero.Inventory.MainItems.Find(x => x.Id == AbilityId.item_rod_of_atos));
            glimmerCape.Update(localHero.Inventory.MainItems.Find(x => x.Id == AbilityId.item_glimmer_cape));
            guardianGreaves.Update(localHero.Inventory.MainItems.Find(x => x.Id == AbilityId.item_guardian_greaves));
            lotusOrb.Update(localHero.Inventory.MainItems.Find(x => x.Id == AbilityId.item_lotus_orb));
            nullifier.Update(localHero.Inventory.MainItems.Find(x => x.Id == AbilityId.item_nullifier));
