namespace O9K.Evader.Abilities.Heroes.Lion.EarthSpike
{
    ...
    internal sealed class EarthSpikeEvadable : LinearProjectileEvadable, IModifierCounter
    {
        public EarthSpikeEvadable(Ability9 ability, IPathfinder pathfinder, IMainMenu menu)
            : base(ability, pathfinder, menu)
        {
            ...
            // Counters.Add(Abilities.SleightOfFist); //todo invul time check
