namespace O9K.Evader.Abilities.Heroes.Pudge.Dismember
{
    ...
    internal sealed class DismemberEvadable : TargetableEvadable, IModifierCounter
    {
        public DismemberEvadable(Ability9 ability, IPathfinder pathfinder, IMainMenu menu)
