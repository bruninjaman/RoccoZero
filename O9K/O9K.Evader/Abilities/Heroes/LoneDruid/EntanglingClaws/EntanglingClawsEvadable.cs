namespace O9K.Evader.Abilities.Heroes.LoneDruid.EntanglingClaws
{
    ...
    internal sealed class EntanglingClawsEvadable : ModifierCounterEvadable
    {
        public EntanglingClawsEvadable(Ability9 ability, IPathfinder pathfinder, IMainMenu menu)
