namespace O9K.Evader.Abilities.Heroes.Terrorblade.TerrorWave
{
    ...
    internal sealed class MetamorphosisEvadable : ModifierCounterEvadable
    {
        public MetamorphosisEvadable(Ability9 ability, IPathfinder pathfinder, IMainMenu menu)
