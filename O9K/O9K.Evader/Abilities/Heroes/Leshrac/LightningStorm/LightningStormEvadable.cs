namespace O9K.Evader.Abilities.Heroes.Leshrac.LightningStorm
{
    ...
    internal sealed class LightningStormEvadable : LinearAreaOfEffectEvadable
    {
        private readonly HashSet<AbilityId> targetCounters = new HashSet<AbilityId>();

        public LightningStormEvadable(Ability9 ability, IPathfinder pathfinder, IMainMenu menu)
