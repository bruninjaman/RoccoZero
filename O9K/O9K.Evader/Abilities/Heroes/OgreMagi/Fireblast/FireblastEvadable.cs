namespace O9K.Evader.Abilities.Heroes.OgreMagi.Fireblast
{
    ...
    internal sealed class FireblastEvadable : TargetableEvadable, IModifierCounter
    {
        public FireblastEvadable(Ability9 ability, IPathfinder pathfinder, IMainMenu menu)
