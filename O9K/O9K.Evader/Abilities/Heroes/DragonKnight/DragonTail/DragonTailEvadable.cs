namespace O9K.Evader.Abilities.Heroes.DragonKnight.DragonTail
{
    ...
    internal sealed class DragonTailEvadable : ProjectileEvadable, IModifierCounter
    {
        public DragonTailEvadable(Ability9 ability, IPathfinder pathfinder, IMainMenu menu)
