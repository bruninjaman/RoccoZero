namespace O9K.Evader.Abilities.Items.Gleipnir
{
    ...
    internal sealed class GleipnirEvadable : ProjectileEvadable, IModifierCounter
    {
        public GleipnirEvadable(Ability9 ability, IPathfinder pathfinder, IMainMenu menu)
