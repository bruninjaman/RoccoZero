namespace O9K.Core.Managers.Menu.Items
{
    ...
    public class MenuSelector<T> : MenuItem
    {
        ...
        public T Selected
        {
            ...
            set
            {
                ...
                if (this.SizeCalculated)
                {
                    ...
                    this.valueTextSize = RendererManager.MeasureText(this.valueText, this.MenuStyle.Font, this.MenuStyle.TextSize);
                }
            }
        }
        ...
        protected override void Draw()
        {
            ...
            RendererManager.DrawText(this.valueText, valuePosition, Color.White, this.MenuStyle.Font, this.MenuStyle.TextSize);
        ...
        private void CalculateFullWidth(T name)
        {
            ...
            var textSize = RendererManager.MeasureText(menuDisplayName, this.MenuStyle.Font, this.MenuStyle.TextSize);
