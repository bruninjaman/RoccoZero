...
//            this.SkewerPrefMenu.ValueChanged += this.SkewerPrefMenuPropertyChanged;
//        }
...
//        {
//            if (GameManager.IsPaused || !this.Owner.IsAlive || !this.Shockwave.CanBeCasted)
//            {
...
//            {
//                if (this.Shockwave.Cast(killstealTarget.Position))
//                {
