...
namespace Divine.BeAware.Helpers
{
    internal sealed class SoundHelper
    {
        ...
        private const string ResourcesSounds = "Divine.BeAware.Resources.Sounds.";

        private static readonly string ResourceDirectory = Path.Combine(Zero.Helpers.Directories.Cache, "Resource", "Divine.BeAware");
