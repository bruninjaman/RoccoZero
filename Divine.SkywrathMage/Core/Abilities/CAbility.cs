...
namespace Divine.Core.Entities
{
    public class CAbility : CEntity
    {
        ...
        {
            return Base.AbilityData.GetRange(index);
        }
        ...
        public virtual bool Cast(Tree target, bool queued, bool bypassQueue)
        {
            return Base.Cast(target, queued, bypassQueue);
        }

        public virtual bool Cast(Tree target, bool queued)
        {
        ...
        public virtual bool Cast(Rune target, bool queued, bool bypassQueue)
        {
            return Base.Cast(target, queued, bypassQueue);
        }

        public virtual bool Cast(Rune target, bool queued)
        {
            return Base.Cast(target, queued);
        }
        ...
        public virtual bool Cast(Unit target, bool queued, bool bypassQueue)
        {
            return Base.Cast(target, queued, bypassQueue);
        }

        public virtual bool Cast(Unit target, bool queued)
        {
            return Base.Cast(target, queued);
        }
        ...
        public virtual bool Cast(Vector3 position, bool queued, bool bypassQueue)
        {
            return Base.Cast(position, queued, bypassQueue);
        }

        public virtual bool Cast(Vector3 position, bool queued)
        {
        ...
        public virtual bool Cast(bool queued, bool bypassQueue)
        {
            return Base.Cast(queued, bypassQueue);
        }

        public virtual bool Cast(bool queued)
        {
        ...
        public bool CastToggle(bool queued, bool bypassQueue)
        {
